  ...
  return (
    <nav className="navbar">
      ...
      <div className="social-links">
        <a href="https://github.com/brandonestrada" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
        ...
        <a href="https://linkedin.com/in/brandonestrada" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
